  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-secondary-background via-primary-background to-secondary-background">
      ...
      <Particles
        ...
        quantity={100}
      />
      <h1 className="z-10 text-4xl text-transparent duration-1000 bg-secondary-foreground cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text ">
        Fabian Aps
      </h1>
