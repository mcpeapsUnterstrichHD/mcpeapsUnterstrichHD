...
export default function RouteComponent() {
  ...
  const skills: SkillCardProps[] = [
    ...
    { SkillTitle: "Apple macOS", SkillBadges: ["Betriebsystem", "Apple", "2 Jahre"], SkillImage: printing ? "/pictures/lebenslauf/skills/macos.svg" : "/pictures/lebenslauf/skills/macos-dorak.svg", SkillImageAlt: "macOS Logo", SkillImageFallback: "macOS", Skilllevel: 90 },
