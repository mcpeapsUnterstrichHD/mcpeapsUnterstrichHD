          ...
          <Link href="/" legacyBehavior passHref>
            <NavigationMenuLink>
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div className="ml-2 mr-2 xs:collapse sm:collapse md:visible lg:visible xl:visible 2xl:visible text-sm font-regular flex flex-row justify-between items-center">
                      Fabian Aps
                    </div>
                </div>
            </NavigationMenuLink>
