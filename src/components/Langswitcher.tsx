...
import { usePathname, useRouter, useLocale } from "@/i18n/navigation";
import * as React from "react";
import { LanguagesNUM, getLanguageDisplayName } from "@/lib/lang";
      ...
      <CollapsibleContent>
        <ListWrapper className={listClasses}>
          {filteredLanguages.length === 0 ? (
            <span className="py-2 text-center text-xs text-muted-foreground">{t("Sidebar.noLanguageFound")}</span>
          ) : (
