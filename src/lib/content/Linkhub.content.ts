  ...
  content: {
    description: t({
      [Locales.ENGLISH_UNITED_STATES]:
        "Code, beats, or random content – find me everywhere.",
      [Locales.GERMAN_GERMANY]:
        "Ob Code, Beats oder Random Content – hier findest du mich überall.",
    }),
    sections: {
      socialMedia: {
        title: t({
        ...
        instagram: {
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "Stories from daily life, events, and everything else.",
            [Locales.GERMAN_GERMANY]:
              "Storys aus dem Alltag, Events und der ganze Rest.",
          }),
        },
        tiktok: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "When I want to show something creative in under a minute.",
            [Locales.GERMAN_GERMANY]:
              "Wenn ich mal was Kreatives in unter einer Minute zeigen will.",
          }),
        },
        threads: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "My thoughts when Instagram isn't enough.",
            [Locales.GERMAN_GERMANY]:
              "Meine Gedanken, wenn Instagram nicht reicht.",
          }),
        },
        bsky: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "For everyone looking for a Twitter alternative.",
            [Locales.GERMAN_GERMANY]:
              "Für alle, die Twitter-Alternative suchen.",
          }),
        },
        twitter: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "Tech discussions and the occasional rant.",
            [Locales.GERMAN_GERMANY]:
              "Tech-Diskussionen und der gelegentliche Rant.",
          }),
        },
        discord: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "Reach me directly here – or just hang out.",
            [Locales.GERMAN_GERMANY]:
              "Hier kann man mich direkt erreichen – oder einfach chillen.",
          }),
        },
        youtube: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "Tutorials, music releases, and whatever else comes to mind.",
            [Locales.GERMAN_GERMANY]:
              "Tutorials, Musik-Releases und was mir sonst einfällt.",
          }),
        },
      },
      websites: {
        ...
        myWebsite: {
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "You're already here – but feel free to look around.",
            [Locales.GERMAN_GERMANY]:
              "Du bist schon hier – aber schau dich ruhig weiter um.",
          }),
        },
        cbps: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "My friend group's website – chaotic, but made with love.",
            [Locales.GERMAN_GERMANY]:
              "Die Website meiner Freundesgruppe – chaotisch, aber mit Liebe gemacht.",
          }),
        },
        blogCBPS: {
          title: t({
      ...
      other: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "What doesn't fit in the other categories.",
          [Locales.GERMAN_GERMANY]:
        ...
        github: {
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "Where my code lives – open source and personal projects.",
            [Locales.GERMAN_GERMANY]:
              "Hier lebt mein Code – Open Source und persönliche Projekte.",
          }),
        },
        playlist: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "From techno to indie – my current soundtrack.",
            [Locales.GERMAN_GERMANY]:
              "Von Techno bis Indie – mein aktueller Soundtrack.",
          }),
        },
        song: {
          title: t({
          ...
          description: t({
            [Locales.ENGLISH_UNITED_STATES]:
              "My latest track – give it a listen!",
