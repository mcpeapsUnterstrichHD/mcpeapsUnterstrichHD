  ...
  content: {
    ...
    items: {
      portfolio: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "The site you're on right now. Next.js, TypeScript, and way too many late nights with CSS.",
          [Locales.GERMAN_GERMANY]:
            "Die Seite, auf der du gerade bist. Next.js, TypeScript, und viel zu viele Nächte mit CSS.",
        }),
        imgAlt: t({
      ...
      simplesql: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "When you want to run SQL statements without setting up an IDE for half an hour. TUI for quick queries.",
          [Locales.GERMAN_GERMANY]:
            "Wenn du SQL-Statements ausführen willst, ohne erst eine halbe Stunde IDE aufzusetzen. TUI für schnelle Queries.",
        }),
        imgAlt: t({
      ...
      localServices: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "SearxNG, Nextcloud, and everything else you need when you don't want to tell Google everything.",
          [Locales.GERMAN_GERMANY]:
            "SearxNG, Nextcloud und was man sonst so braucht, wenn man Google nicht alles erzählen will.",
        }),
        imgAlt: t({
      ...
      schulRepo: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Three years of OSZ IMT in code – from first Java baby steps to real projects.",
          [Locales.GERMAN_GERMANY]:
            "Drei Jahre OSZ IMT in Code – von den ersten Java-Gehversuchen bis zu echten Projekten.",
        }),
        imgAlt: t({
      ...
      klassenWebsite: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "The official class website. Built with the crew, hosted with pride.",
          [Locales.GERMAN_GERMANY]:
            "Die offizielle Klassenwebsite. Gebaut mit der Crew, gehostet mit Stolz.",
        }),
        imgAlt: t({
          [Locales.ENGLISH_UNITED_STATES]: "OSZ IMT Logo",
          [Locales.GERMAN_GERMANY]: "OSZ IMT Logo",
      ...
      klassenApp: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Schedule changes, grade calculator, class chat – everything we needed in school.",
          [Locales.GERMAN_GERMANY]:
            "Vertretungsplan, Notenrechner, Klassenchat – alles was wir im Schulalltag gebraucht haben.",
        }),
        imgAlt: t({
      ...
      simpleSqlRunner: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "The GUI version of simplesql. For those who prefer clicking over typing.",
          [Locales.GERMAN_GERMANY]:
            "Die GUI-Version von simplesql. Für alle, die lieber klicken als tippen.",
        }),
        imgAlt: t({
      ...
      dotfilesMacos: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "My complete Mac setup in one repo. Zsh, Neovim, Homebrew – all included.",
          [Locales.GERMAN_GERMANY]:
            "Mein komplettes Mac-Setup in einem Repo. Zsh, Neovim, Homebrew – alles dabei.",
        }),
        imgAlt: t({
      ...
      nixConfig: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Reproducible system setup. Configure once, deploy anywhere.",
          [Locales.GERMAN_GERMANY]:
            "Reproduzierbares System-Setup. Einmal konfigurieren, überall deployen.",
        }),
        imgAlt: t({
      ...
      dotfilesLinux: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Same philosophy, different OS. Hyprland, Waybar, and the whole Wayland stack.",
          [Locales.GERMAN_GERMANY]:
            "Gleiche Philosophie, anderes OS. Hyprland, Waybar und der ganze Wayland-Stack.",
        }),
        imgAlt: t({
      ...
      cbpsWebsite: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "The digital home of my friend group. Chaotic, colorful, and absolutely us.",
          [Locales.GERMAN_GERMANY]:
            "Die digitale Heimat meiner Freundesgruppe. Chaotisch, bunt und absolut wir.",
        }),
        imgAlt: t({
      ...
      cbpsApp: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Plan private events, share memes, collect inside jokes – the crew app.",
          [Locales.GERMAN_GERMANY]:
            "Private Events planen, Memes teilen, Insider-Jokes sammeln – die Crew-App.",
        }),
        imgAlt: t({
      ...
      uniRepo: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Algorithms, data structures, and proof that I can actually do math.",
          [Locales.GERMAN_GERMANY]:
            "Algorithmen, Datenstrukturen, und der Beweis dass ich doch noch Mathe kann.",
        }),
        imgAlt: t({
      ...
      liveWallpaper: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Particles in Nord theme, C++23 under the hood, runs native and in browser. My playground for shader experiments.",
          [Locales.GERMAN_GERMANY]:
            "Partikel im Nord-Theme, C++23 unter der Haube, läuft native und im Browser. Mein Spielplatz für Shader-Experimente.",
        }),
        imgAlt: t({
