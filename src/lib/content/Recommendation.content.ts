...
const recommendationContent = {
  ...
  content: {
    projects: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "See what happens when I can't sleep at night.",
        [Locales.GERMAN_GERMANY]:
          "Schau dir an, was passiert wenn ich nachts nicht schlafen kann.",
      }),
      action: {
        label: t({
    ...
    aboutme: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "IT nerd by day, DJ by night – get to know me.",
        [Locales.GERMAN_GERMANY]:
          "IT-Nerd bei Tag, DJ bei Nacht – lern mich kennen.",
      }),
      action: {
        label: t({
    ...
    cv: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "My journey through the IT world – all the stops.",
        [Locales.GERMAN_GERMANY]:
          "Mein Weg durch die IT-Welt – mit allen Stationen.",
      }),
      action: {
        label: t({
    ...
    linkhub: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "From Instagram to GitHub – here's where I hang out.",
        [Locales.GERMAN_GERMANY]:
          "Von Instagram bis GitHub – hier bin ich unterwegs.",
      }),
      action: {
        label: t({
    ...
    github: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "@mcpeapsUnterstrichHD – Open source with passion.",
        [Locales.GERMAN_GERMANY]:
          "@mcpeapsUnterstrichHD – Open Source aus Leidenschaft.",
      }),
      action: {
        label: t({
    ...
    twitter: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "@mcpeaps_HD – Tech talks and random thoughts.",
        [Locales.GERMAN_GERMANY]:
          "@mcpeaps_HD – Tech-Talks und Random Thoughts.",
      }),
      action: {
        label: t({
    ...
    instagram: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "@mcpeaps_hd – My daily life in pictures.",
    ...
    threads: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "@mcpeaps_hd – When a tweet isn't enough.",
    ...
    bluesky: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "@mcpeapsunterstrichhd.dev – Decentralized and free.",
        [Locales.GERMAN_GERMANY]:
          "@mcpeapsunterstrichhd.dev – Dezentral und frei.",
      }),
      action: {
        label: t({
