  ...
  content: {
    ...
    description: t({
      [Locales.ENGLISH_UNITED_STATES]:
        "This website uses cookies to ensure you get the best experience. We do not collect any analytics data about you or your device. Only technically necessary cookies are set by default. Third-party content can be blocked at your discretion. Your cookie preferences are stored for 7 days.",
      [Locales.GERMAN_GERMANY]:
        "Diese Website verwendet Cookies, um Ihnen das beste Erlebnis zu bieten. Es werden keinerlei analytische Daten über Sie oder Ihr Gerät erhoben. Standardmäßig werden nur technisch notwendige Cookies gesetzt. Inhalte von Drittanbietern können auf Wunsch blockiert werden. Ihre Cookie-Einstellungen werden für 7 Tage gespeichert.",
    }),
    technicalCookies: {
      title: t({
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "These cookies are required for basic site functionality, such as remembering your preferences and language settings. They cannot be disabled. No personal or analytical data is collected.",
        [Locales.GERMAN_GERMANY]:
          "Diese Cookies sind für grundlegende Website-Funktionen erforderlich, wie das Speichern Ihrer Einstellungen und Sprachpräferenzen. Sie können nicht deaktiviert werden. Es werden keine persönlichen oder analytischen Daten erhoben.",
      }),
    },
    thirdPartyCookies: {
      title: t({
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "Some pages contain embedded content from third-party services like Cal.com or Apple Music. These services may set their own cookies, which are outside of my control. You can block this content at any time via your cookie settings.",
        [Locales.GERMAN_GERMANY]:
          "Einige Seiten enthalten eingebettete Inhalte von Drittanbietern wie Cal.com oder Apple Music. Diese Dienste können eigene Cookies setzen, die außerhalb meiner Kontrolle liegen. Sie können diese Inhalte jederzeit über Ihre Cookie-Einstellungen blockieren.",
      }),
    },
    acceptAll: t({
    ...
    categories: {
      multimedia: {
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Required for embedded media like Apple Music and Songlink players.",
          [Locales.GERMAN_GERMANY]:
            "Erforderlich für eingebettete Medien wie Apple Music und Songlink Player.",
        }),
      },
      socialMedia: {
        title: t({
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Required for embedded social media content.",
          [Locales.GERMAN_GERMANY]:
            "Erforderlich für eingebettete Social-Media-Inhalte.",
        }),
      },
      contact: {
        title: t({
        ...
        description: t({
          [Locales.ENGLISH_UNITED_STATES]:
            "Required for the Cal.com booking calendar.",
          [Locales.GERMAN_GERMANY]:
            "Erforderlich für den Cal.com Buchungskalender.",
        }),
      },
    },
    blockedContent: {
      ...
      description: t({
        [Locales.ENGLISH_UNITED_STATES]:
          "This content is blocked because you haven't accepted the required cookies. Enable the corresponding category: ({category}) in your cookie settings to view this content.",
        [Locales.GERMAN_GERMANY]:
          "Dieser Inhalt ist blockiert, da Sie die entsprechenden Cookies nicht akzeptiert haben. Aktivieren Sie die entsprechende Kategorie: ({category}) in Ihren Cookie-Einstellungen, um diesen Inhalt anzuzeigen.",
      }),
      button: t({
        [Locales.ENGLISH_UNITED_STATES]: "Cookie Settings",
        [Locales.GERMAN_GERMANY]: "Cookie-Einstellungen",
